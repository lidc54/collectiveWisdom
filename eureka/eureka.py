...
import os
# import openai
from proxy.proxy import get_openai_response
import re
import subprocess
...
from utils.prune_env import extract_self_variable
...
def main(cfg):
    ...
    for iter in range(cfg.iteration):
        ...
        while True:
            ...
            for attempt in range(1000):
                try:
                    ...
                    response_cur = eval(get_openai_response(data))
        ...
        for response_id in range(cfg.sample):
            ...
            set_freest_gpu(cfg.visible_gpus)
